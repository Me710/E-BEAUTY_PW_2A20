...
<section id="home" class="video-hero js-fullheight" style="height: 700px; background-image: url(img/bg_1.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;">
	              ...
	              <p>Far far away, behind the word mountains, far from the countries Vokalia </p>
	    			...
	    			<div class="col-md-6 col-lg-3 ftco-animate">
	    				<div class="model-entry">
			    			<div class="model-img" style="background-image: url(img/image_1.jpg);">
			    				<div class="name text-center">
			    					<h3><a href="tuto.php">PROFILE</a></h3>
			    				</div>
			    				<div class="text text-center">
			    					<h3><a href="tutos.php">your<br><span>profile</span></a></h3>
		    		...
		    		<div class="col-md-6 col-lg-3 ftco-animate">
		    			<div class="model-entry">
			    			<div class="model-img" style="background-image: url(img/image_2.jpg);">
			    				<div class="name text-center">
			    					<h3><a href="tutos.php">products</a></h3>
			    				</div>
			    				<div class="text text-center">
			    					<h3><a href="tutos.php">products<br><span>management</span></a></h3>
			    					<div class="d-flex models-info">
			    						<div class="box">
		                		<p>Height</p>
		                		<span>185</span>
	    			...
	    			<div class="col-md-6 col-lg-3 ftco-animate">
	    				<div class="model-entry">
			    			<div class="model-img" style="background-image: url(img/image_3.jpg);">
			    				<div class="name text-center">
			    					<h3><a href="tutos.php">orders</a></h3>
			    				</div>
			    				<div class="text text-center">
			    					<h3><a href="tutos.php">make<br><span>an order</span></a></h3>
			    					<div class="d-flex models-info">
			    						<div class="box">
		                		<p>Height</p>
		                		<span>185</span>
	    			...
	    			<div class="col-md-6 col-lg-3 ftco-animate">
	    				<div class="model-entry">
			    			<div class="model-img" style="background-image: url(img/image_5.jpg);">
			    				<div class="name text-center">
			    					<h3><a href="tutos.php">videos</a></h3>
			    				</div>
			    				<div class="text text-center">
			    					<h3><a href="tutos.php">tuto<br><span>videos</span></a></h3>
			    					<div class="d-flex models-info">
			    						<div class="box">
		                		<p>Height</p>
		                		<span>185</span>
	    			...
	    			<div class="col-md-6 col-lg-3 ftco-animate">
	    				<div class="model-entry">
			    			<div class="model-img" style="background-image: url(img/image_6.jpg);">
			    				<div class="name text-center">
			    					<h3><a href="tutos.php">blogs</a></h3>
			    				</div>
			    				<div class="text text-center">
			    					<h3><a href="tutos.php">visit<br><span>our blogs</span></a></h3>
			    					<div class="d-flex models-info">
			    						<div class="box">
		                		<p>Height</p>
		                		<span>185</span>
	    			...
	    			<div class="col-md-6 col-lg-3 ftco-animate">
	    				<div class="model-entry">
			    			<div class="model-img" style="background-image: url(img/image_7.jpg);">
			    				<div class="name text-center">
			    					<h3><a href="tutos.php">treatements</a></h3>
			    				</div>
			    				<div class="text text-center">
			    					<h3><a href="tutos.php">get<br><span>yours</span></a></h3>
			    					<div class="d-flex models-info">
			    						<div class="box">
		                		<p>Height</p>
		                		<span>185</span>
	    ...
	    <section class="ftco-section testimony-section img" style="background-image: url(img/bg_2.jpg);">
	    	<div class="overlay"></div>
	      <div class="container">
	    ...
	    <section class="ftco-quote ftco-section ftco-animate">
	    	<div class="container">
	    		<div class="row d-flex">
	    			<div class="col-md-6 req-quote py-5 text-center align-items-center img" style="background-image: url(img/bg_2.jpg);">
		    			<h3 class="ml-md-3">Become A Model?</h3>
		    			<span class="ml-md-3"><a href="#">Call us now to know how!</a></span>
	    			</div>
	    			<div class="col-md-6 req-quote py-5 text-center align-items-center img" style="background-image: url(img/bg_1.jpg);">
