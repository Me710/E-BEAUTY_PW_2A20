...
include_once('C:/xampp/htdocs/E_Beauty/Controller/reclamationC.php'); 
    ...
    $Reclams = $userdb->afficherReclamsBDD($_SESSION["USERID"]);      
?>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">Les informations sur les dernieres reclamations </p>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                      <table class="table">
                                        ...
                                        <tbody>
                                         <tr>
                                          <?php foreach($Reclams as $Rc) { ?>
                                            
                                            <tr>
                                                <td><?php Echo $Rc['TEMID'] ?></td>
                                                <td><?php Echo $Rc['USERID'] ?></td>
                                                <td><?php Echo $Rc['DATE_R'] ?></td>
                                                <td><?php Echo $Rc['MESSAGE'] ?></td> 
                                                <div>
                                                    <td>
                                                    <form method="POST" action="form_modifier.php">
                                                      <input class="btn-outline-success" type="text" name="statut" value="<?php Echo $Rc['STATUT'] ?>" readonly>
                                                      <input type="hidden" value=<?php echo $Rc['USERID']?> name="USERID">
                                                    </form>
                                                    </td>
                                                    <td>
                                                    <a href="supprimerClient.php?USERID=<?php echo $Rc['TEMID'] ?>" class="btn-outline-danger">Supprimer</a>
                                                    </td>
                                                </div> 
                                                <?php } ?>
                                            </tr>
