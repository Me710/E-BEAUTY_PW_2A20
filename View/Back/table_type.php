    ...
    if (
	  ...
	  isset($_POST["Nom"])
        ...
        if (
            ...
            $typeB->ajouter_type($type);
            header('Location:table_type.php');
        }
        else
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="ui-ajout">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/E_Beauty/View/Back/ajout_blog">BLOGS</a>
          </li>
          <li class="nav-item">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">informations sur le type</p>
                        <div id="error">
                          <?php echo $error; ?>
                        </div>
                    <form class="forms-sample" action="" method="POST" onsubmit="return Verif()">
                      ...
                      <div class="form-group">
                        <label for="id_type">id du type</label>
                        <input
                          type="text"
                          class="form-control"
                          id="id_type"
