<?php
    ...
    if (
        ...
        $servicedb = new PackC();    
        $result = $servicedb->afficherpacks(); 
        ?>
        <!DOCTYPE html>
        <html lang="en"> 
                      ...
                      <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <form name="formAddPack" class="forms-sample" action="" method="POST" enctype="multipart/form-data" onsubmit="return verifPack()">
                            <div class="form-group">
                                ...
                                />
                                <p style="color:red;" id="errorNomP" class="error"></p> 
                              </div>  
                            <div class="form-group">
                                ...
                                />
                                <p style="color:red;" id="errorDescP" class="error"></p> 
                              </div>
                              <div class="form-group">
