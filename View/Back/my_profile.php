      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white"><?php echo $Client['USERNAME'];?></h1>
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
              <div class="d-flex justify-content-between">
                <a href="deconnexion.php" class="btn btn-sm btn-info mr-4">LogOut</a>
            ...
            <div class="card-body pt-0 pt-md-4">
              <div class="row">
                <div class="col">
                  <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                    ...
                    <div>
                      <span class="heading">0</span>
                      <span class="description">Reclammations</span>
                    </div>
                    <div><input
                          type="hidden"
                          class="form-control"
              ...
              <div class="text-center">
                <h3>
                  <?php echo $Client['FIRSTNAME'];?><span class="font-weight-light">, 21</span>
                </h3>
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i><?php echo $Client['VILLE'];?> Tunisia
                </div>
          ...
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form action="" method="POST">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" name="UserName" value=<?php echo $Client['USERNAME'];?>>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Email address</label>
                        <input type="email" id="input-email" class="form-control form-control-alternative" name="Email" placeholder="mail@example.com" value=<?php echo $Client['EMAIL'];?>>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="First name" name="FirstName" value=<?php echo $Client['FIRSTNAME'];?>>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Last name</label>
                        <input type="text" id="input-last-name" class="form-control form-control-alternative" placeholder="Last name" name="LastName"value=<?php echo $Client['LASTNAME'];?>>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group focused">
                        ...
                        <input id="input-address" class="form-control form-control-alternative" placeholder="Home Address" name="Ville" value=<?php echo $Client['VILLE'];?> type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-city" class="form-control form-control-alternative" placeholder="City" name="Ville2" value=<?php echo $Client['VILLE'];?>>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group focused">
                ...
                <div class="pl-lg-4">
                  <div class="form-group focused">
                    <label>Ajouter une Reclammation</label>
