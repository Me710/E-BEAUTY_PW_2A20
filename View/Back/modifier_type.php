<?php
    include('C:/xampp/htdocs/E_Beauty/Model/Type.php'); 
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">nouvelles informations</p>
                        ...
                        <?php
                            if (isset($_POST['id_type'])){
                                $ID =  $_POST['id_type'];
                                $Type = $TypeB->recuperer_type($_POST['id_type']);	
                        ?>
                    <form class="forms-sample" action="" method="POST">
                      ...
                      <button><a href="index.php">Retour à la liste des Types</a></button>
                    </form>
                  <?php
                  }
                  ?>
