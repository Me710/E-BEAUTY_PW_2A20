...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT * FROM categorie WHERE nom_categorie LIKE ? OR id_categorie LIKE ? OR image_categorie LIKE ?");
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Categorie produit</h4>
                    ...
                    <div class="table-responsive">
                      ...
                      while($terme_trouve = $select_terme->fetch())
                      {
                        ?>
                          <tr>
                            <td> <?php echo $terme_trouve['id_categorie']; ?></td>
                            <td><?php echo $terme_trouve['nom_categorie']; ?></td>
                          ...
                          <input type="hidden" value=<?PHP echo $terme_trouve['id_categorie']; ?> name="id_categorie">
                          </form>
                          </td>
                                                            <td>
                                                                <a  href="Supprimer_categorie.php?id_categorie=<?php echo $terme_trouve['id_categorie']; ?>">  <input class="btn btn-danger waves-effect waves-light" type="submit" value="Supprimer"></a><i class="mdi mdi-delete"></i>
                                                            </td>
                        </tbody>
                        <?php  }
                    ...
                    <div class="p-15 p-b-0">
                                                        <form class="form-material" action = "verif-formcategorie.php" method ="get">
...
<form method="POST" action="triecategorie.php">
...
<?php //echo'<img src="../../assets/images/images/'.$categorie['image_categorie'].'"width="100;" height="100" alt="Image">'  ?>