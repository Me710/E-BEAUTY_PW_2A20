              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div id="error">
                    ...
                    <p class="card-description"> Ajouter catégorie </p>
                    <form class="forms-sample" method="POST">
                    <div class="form-group form-default">
                    <label class="float-label">Id</label>
                      <input type="number" name="id_categorie" id="id_categorie"   class="form-control" required="" onblur="saisirID()">
                      <span class="form-bar"></span>
                      <p id="errorID" class="erreur" ></p> 
                      </div>

                      <div class="form-group form-default ">
                      <label class="float-label">Nom_categorie</label>
                        <input type="text"  id="nom_categorie" name="nom_categorie" class="form-control" required=""   onblur="saisirNom()" >
                         <span class="form-bar"></span>
                      ...
                      <input type="submit" onclick="ajout(categorie)" value="Ajouter"  class="btn btn-primary mr-2"> 
                    </form>
                  </div>
                </div>
              </div>
