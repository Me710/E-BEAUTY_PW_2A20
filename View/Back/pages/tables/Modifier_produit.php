              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> modifier produit </p>
                    <?php
                    ...
                    <form class="forms-sample"method="POST">
                        ...
                        <input type="number" class="form-control" id="id_produit" name="id_produit" placeholder="id produit"value="<?php echo $produit['id_produit']; ?>" required="" onblur="saisirID()">
                        <p id="errorID" class="erreur" ></p>   
                      </div>

                      <div class="form-group">
                        <label for="nom_produit">Nom produit</label>
                        <input type="text" class="form-control" id="nom_produit" name="nom_produit" placeholder="nom produit"value="<?php echo $produit['nom_produit']; ?>" required="" onblur="saisirNom()">
                        <p id="errorName" class="erreur" ></p>   
                      </div>

                      <div class="form-group">
                        <label for="prix_produit">Prix produit</label>
                        <input type="text" class="form-control" id="prix_produit" name="prix_produit" placeholder="prix produit"value="<?php echo $produit['prix_produit']; ?>" required="" onblur="saisirPrix()">
                        <p id="errorPrix" class="erreur" ></p> 
                      </div>

                      <div class="form-group">
                        <label for="quantite_produit">Quantite produit</label>
                        <input type="text" class="form-control" id="quantite_produit" name="quantite_produit" placeholder="quantite produit"value="<?php echo $produit['quantite_produit']; ?>" required="" onblur="saisirQuantite()">
                        <p id="errorQuantity" class="erreur" ></p> 
                      </div>

                      <div class="form-group">
                        <label for="descrip_produit">Description produit</label>
                        <input type="text" class="form-control" id="descrip_produit" name="descrip_produit" placeholder="descrip produit"value="<?php echo $produit['descrip_produit']; ?>" required="" >
                      ...
                      <input type="submit" onclick="ajout(produit)" value="Modifier"  class="btn btn-primary mr-2">
                    </form>
                    <?php
                    }
                    ?>
