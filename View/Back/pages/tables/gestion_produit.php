                      ...
                      <table class="table table-hover">
                        ...
                        ?>
                          ...
                          <input type="hidden" value=<?PHP echo $produit['id_produit']; ?> name="id_produit">
                                                            ...
                                                            <td>
                                                                <a  href="Supprimer_produit.php?id_produit=<?php echo $produit['id_produit']; ?>">  <input class="btn btn-danger waves-effect waves-light" type="submit" value="Supprimer"></a><i class="mdi mdi-delete"></i>
                                                            </td>
                        </tbody>
                        <?php } ?>
                      </table>
...
<input type="submit"  name="pdf" id="pdf"  class="btn btn-success create-new-button" value="Fichier pdf" ></input>
