<?php
    ...
    {
    $listecategorie=$categorieC->triercategorieDESC();
    session_start();
    }
    else {
        $listecategorie=$categorieC->triercategorieASC();
        session_start();
    }
?>
                      ...
                      <table class="table table-hover">
                        ...
                        ?>
                          ...
                          <input type="hidden" value=<?PHP echo $categorie['id_categorie']; ?> name="id_categorie">
                                                            ...
                                                            <td>
                                                                <a  href="Supprimer_categorie.php?id_categorie=<?php echo $categorie['id_categorie']; ?>">  <input class="btn btn-danger waves-effect waves-light" type="submit" value="Supprimer"></a><i class="mdi mdi-delete"></i>
                                                            </td>
                        </tbody>
                        <?php } ?>
                      </table>
