...
<html lang="en">
  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> modifier catégorie </h3>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> modifier catégorie </p>
                    <?php
                    ...
                    <form class="forms-sample"method="POST">
                        ...
                        <input type="number" class="form-control" id="id_categorie" name="id_categorie" placeholder="id categorie"value="<?php echo $categorie['id_categorie']; ?>" required="" onblur="saisirID()">
                        <p id="errorID" class="erreur" ></p>   
                      </div>

                      <div class="form-group">
                        <label for="nom_categorie">Nom catégorie</label>
                        <input type="text" class="form-control" id="nom_categorie" name="nom_categorie" placeholder="nom categorie"value="<?php echo $categorie['nom_categorie']; ?>" required="" onblur="saisirNom()">
                        <p id="errorName" class="erreur" ></p> 
                      </div>
                      
                      <div class="form-group ">
                        <input type="file"  id="image_categorie" name="image_categorie"  class="form-control"required="">
                        <span class="form-bar"></span>
                        <label class="file-upload-browse btn btn-primary"></label>
                      </div>  
                      
                     
                      <input type="submit" onclick="ajout(categorie)" value="Modifier"  class="btn btn-primary mr-2">
                    </form>
                    <?php
                    }
                    ?>
    ...
    <script>
    function saisirNom() {
                var name = document.getElementById('nom_categorie').value;
                var regex = /^[A-Za-z]+$/;
