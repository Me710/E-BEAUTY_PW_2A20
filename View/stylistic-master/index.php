        ...
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              ...
              <ul>
                <li class="active"><a href="index.php"><span>Acceuil</span></a></li>
    ...
    <div id="colorlib-page">
      <header>
      	<div class="container">
			...
			<section id="Acceuil" class="video-hero js-fullheight" style="height: 700px; background-image: url(images/bg_1.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;">
				<div class="overlay"></div>
				<a class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=ITUid-bDsl8',containment:'#Acceuil', showControls:false, autoPlay:true, loop:true, mute:true, startAt:0, opacity:1, quality:'default'}"></a>
				<div class="container">
					<div class="row js-fullheight justify-content-center d-flex align-items-center">
						<div class="col-md-8">
							<div class="text text-center">
								<span class="subheading">Bienvenue à</span>
								<h2>E-Beauty</h2>
								<h3 class="mb-4">For Your Beautiful Soul</h3>
								<p><a href="#" class="btn btn-primary py-3 px-4">Soyez A la Mode</a></p>
							</div>
						</div>
					</div>
				</div>
	    				...
	    				<div class="model-entry">
			    			<div class="model-img" style="background-image: url(images/image_1.jpg);">
			    				<div class="name text-center">
			    					<h3><a href="model-single.php">PROFILE</a></h3>
			    				</div>
			    				<div class="text text-center">
			    					<h3><a href="model-single.php">your<br><span>profile</span></a></h3>
	    			...
	    			<div class="col-md-6 col-lg-3 ftco-animate">
	    				<div class="model-entry">
			    			<div class="model-img" style="background-image: url(images/image_6.jpg);">
			    				...
			    				<div class="text text-center">
			    					<h3><a href="model-single.php">visit<br><span>NOS BLOGS</span></a></h3>
			    					<div class="d-flex models-info">
			    						<div class="box">
		                		<p>Height</p>
		                		<span>185</span>
	    ...
	    <section class="ftco-appointment ftco-section">
				...
				<div class="container">
					<div class="row justify-content-center">
	      		<div class="col-md-8 mb-5 heading-section text-center ftco-animate">
	      			<span class="subheading">Stilistique</span>
	    	...
	    	<div class="container">
	    		<div class="row d-flex">
	    			<div class="col-md-6 req-quote py-5 text-center align-items-center img" style="background-image: url(images/bg_2.jpg);">
		    			<h3 class="ml-md-3">Soyez A la Mode?</h3>
	        ...
	        <div class="row mb-5">
	          <div class="col-md-3">
	            <div class="ftco-footer-widget mb-4">
	              <h2 class="ftco-heading-2 logo"><a href="index.php">Stilistique</a></h2>
