...
<html lang="en">
  <head>
    <title>Stilistique - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
        ...
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              <h1 class="mb-4"><a href="index.php" class="logo">Stilistique<br><span>Agence de Model</span></a></h1>
              <ul>
      ...
      <header>
      	<div class="container">
	        <div class="colorlib-navbar-brand">
	          <a class="colorlib-logo" href="index.php">Stilistique<br><span>Agence de Model</span></a>
	        </div>
	      ...
	      <div class="container">
	        <div class="row no-gutters text align-items-end justify-content-center" data-scrollax-parent="true">
	          <div class="col-md-8 ftco-animate text-center">
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Acceuil</a></span> <span>Blog Single</span></p>
	          ...
	          <div class="col-lg-8 ftco-animate">
	            ...
	            <div class="pt-5 mt-5">
	              ...
	              <div class="comment-form-wrap pt-5">
	                ...
	                <form action="#" class="comment-form p-5 bg-dark">
	            ...
	            <div class="sidebar-box ftco-animate">
	              ...
	              <div class="block-21 mb-4 d-flex">
	                ...
	                <div class="text">
	                  ...
	                  <div class="meta">
	                    <div><a href="#"><span class="icon-calendar"></span> May 17, 2019</a></div>
