    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="ajoutertuto.php">
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
              </span>
              <span class="menu-title">Ajout video</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="ajoutercommentaire.php">
              <span class="menu-icon">
                <i class="mdi mdi-chart-bar"></i>
              </span>
              <span class="menu-title">Ajout commentaire</span>
            </a>
          </li>
        </ul>
      </nav>
